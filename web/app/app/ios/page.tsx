...
export const metadata = { title: "Mob Tennis for iOS" };

export default function IosPage() {
  return (
    <article className="space-y-4 pt-2">
      <header>
        <h1 className="text-2xl font-bold tracking-tight">Mob Tennis for iOS</h1>
      ...
      <section className="rounded-lg border border-ink-700 bg-ink-900 p-4 shadow-card">
        <p className="text-sm text-text-secondary">
          ...
          in the next couple of days. Until then, the full Mob Tennis experience
