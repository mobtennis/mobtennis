...
export const metadata = { title: "Mobtennis for Android" };

export default function AndroidPage() {
  return (
    <article className="space-y-4 pt-2">
      <header>
        <h1 className="text-2xl font-bold tracking-tight">Mobtennis for Android</h1>
      ...
      <section className="rounded-lg border border-ink-700 bg-ink-900 p-4 shadow-card">
        <p className="text-sm text-text-secondary">
          ...
          published in the next couple of days. Until then, the full Mobtennis
